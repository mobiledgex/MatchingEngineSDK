...
extension MobiledgeXiOSLibrary {
    ...
    public class MatchingEngine {
        ...
        var client: DistributedMatchEngine_MatchEngineApiClient
        ...
        public init() {
            ...
            let channel = ClientConnection.secure(group: group).connect(host: "wifi.dme.mobiledgex.net", port: 50051)
            client = DistributedMatchEngine_MatchEngineApiClient.init(channel: channel)
            /*defer {
