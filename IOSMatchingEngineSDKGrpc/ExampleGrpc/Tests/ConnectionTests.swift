...
class ConnectionTests: XCTestCase {
    ...
    let host = "porttestcluster.automationhamburgcloudlet.tdg.mobiledgex.net"
    ...
    func testWebsocketConnection() {
        ...
        // SocketIO server
        let port = "3838"
        let wsHost = "reservable2.dusseldorf-main.tdg.mobiledgex.net"
    ...
    func testGetConnectionWorkflow() {
        ...
        let replyPromise = matchingEngine.registerAndFindCloudlet(host: dmeHost, port: dmePort, orgName: orgName, appName: appName, appVers: appVers, gpsLocation: loc, carrierName: "TDG")
