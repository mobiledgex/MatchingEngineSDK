...
extension MobiledgeXiOSLibrary.MatchingEngine
{
    ...
    public func createRegisterClientRequest(orgName: String, appName: String?, appVers: String?, carrierName: String? = nil, authToken: String? = nil, uniqueIDType: IDTypes? = nil, uniqueID: String? = nil, cellID: UInt32? = nil, tags: [Tag]? = nil)
